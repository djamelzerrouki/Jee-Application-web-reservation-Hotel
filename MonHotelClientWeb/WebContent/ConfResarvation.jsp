...
<%--  	 <%@include file="HeadMinu.jsp" %>   --%>
	...
	<form action="controleur.do#ConfermerReservation" method="post" id="Reservation"
		...
		<ul>
			...
			<li>
				<div>
					Nom :  <label for="nom"> <span>${reservation.nom }</span></label>
				</div>
			...
			<li>
				<div>
					Prénom :  <label for="Prénom"> ${reservation.prenom } </label>
				</div>
			...
			<li>
			<div>
					Email :  <label for="Email"> <span>${reservation.email }</span></label>
				</div>
			</li>
			<li>
			<div>
					Tléphon :  <label for="Tléphon"> ${reservation.tlphon } </label>
				</div>
			</li>
