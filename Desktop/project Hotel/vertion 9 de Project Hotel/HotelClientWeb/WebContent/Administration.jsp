...
<body id="top">
	  ...
	  <br/><br/>
	  <h1   class="titel">Administration</h1>
	  	<form action="Hotel.Ca" method="post" id="Login"
		class="form-style-9">



		<ul>
			<h1 class="titel">LOGIN Administration</h1>
			<li>
				<div>
			...
			<li>
				<div>
					<input type="password" name="password"
						class="field-style field-split align-left" placeholder="Mot de passe"
						size="22" required /> <label for="nom"><span>*</span></label>
				</div>
